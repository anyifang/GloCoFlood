...
GEOJSON_PATH="${GEOJSON_PATH:-${HYDROMT_SFINCS_EXAMPLES}/BoB_SFINCS/cama_upstream_rivers.geojson}"
REGION_NAME="YRD_Auto"
...
ERA5_DAILY_ROOT="${ERA5_DAILY_ROOT:-${CAMA_DIR}/VIC_Data/ERA5}"
